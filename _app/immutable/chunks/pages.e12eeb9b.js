...
type Query {
  ...
  to retrieve a specific Transaction Details.
  """
  transactionDetails(identityValue: String!, input: TransactionDetailsInput!): TransactionDetailsResponse
}
...
input TransactionDetailsInput {
  "Internal Transaction ID to search"
  transactionId: String!
}
