...
type Mutation {
  ...
  <img src="https://usdvexperts.com/wp-content/uploads/2016/02/c286ca98c6c79cf50000cab7a5344393-e1458196160872.png" alt="pending" width="32" style="vertical-align:middle"/>
  <p>
  This API method allows cancel prevously called CreditCustomerPointsOrRewards
  the way to cancel paricular transaction to keep expiration dates for other items correct
  </p>
  </div>
  """
  CancelCreditCustomerPointsOrRewards(identityValue: String!, cancelInput: CancelCreditInput!): CancelCreditResponse
}
