...
type Mutation {
  ...
  """
  creditOrDebitPunch(identityValue: String!, input: CreditOrDebitPunchInput!): CreditOrDebitPunchResponse
}
...
type CreditOrDebitPunchResponse {
...
type BenefitTransaction {
  ...
  """Current number of puches achived with the transaction"""
  currentUnits: Int
  """
