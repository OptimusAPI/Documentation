...
type Mutation {
  ...
  """
  creditCustomerRewards(identityValue: String!, creditInput: CreditCustomerRewardsInput!): CreditCustomerRewardsResponse
  """
  <div>
  <img src="https://cdn-icons-png.flaticon.com/512/6928/6928921.png" alt="verified" width="32" style="vertical-align:middle"/>
  <img src="https://uxwing.com/wp-content/themes/uxwing/download/checkmark-cross/done-icon.png" alt="developed" width="32" style="vertical-align:middle"/>
...
input CreditCustomerRewardsInput {
  "Campaign ID to load"
  campaignId: String!
  "Amount, increamented by 5"
  rewardAmount: Int
  "State to set"
  rewardState: BenefitState!
}
...
type CreditCustomerRewardsResponse {
