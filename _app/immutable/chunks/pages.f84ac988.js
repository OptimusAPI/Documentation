...
input CustomerPointsHistoryInput {
  "Filter by dates range"
  dates: DatesEntity
  "Filter pending points by txn reference / no history points will be return if not empty"
  transactionId: String
}
