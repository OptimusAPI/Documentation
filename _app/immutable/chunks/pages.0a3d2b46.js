...
`;class rD{constructor(n){Ie(this,"mapping");this.mapping=n}getFor(n){return this.mapping.get(n.name)}}var or;(function(i){i.UNION="union",i.ARGUMENT="argument",i.FIELD="field"})(or||(or={}));function sD(i){const n=new Map;return aD(i,t=>{Tn(t)&&oD(t,s=>{const a=go(s.type);ao(n,a).references.push({kind:or.FIELD,parent:t,by:s}),uD(s,l=>{const d=go(l.type);ao(n,d).references.push({kind:or.ARGUMENT,field:s,type:t,by:l})})}),Kn(t)&&t.getTypes().forEach(s=>{ao(n,s).references.push({kind:or.UNION,by:t})})}),new rD(n)}function aD(i,n){Object.entries(i.getTypeMap()).forEach(([,t])=>{t.name.startsWith("__")||n(t)})}function oD(i,n){Object.entries(i.getFields()).forEach(([,t])=>{n(t)})}function uD(i,n){Object.entries(i.args).forEach(([,t])=>{n(t)})}function ao(i,n){let t=i.get(n.name);return t||(t={references:[]},i.set(n.name,t)),t}function go(i){return ln(i)||di(i)?go(i.ofType):i}const fn=vD(),yo=wo(bo.DIRECTIVES,[]);var Wc;const lD=Os((Wc=fn.getQueryType())==null?void 0:Wc.getFields());var Yc;const cD=Os((Yc=fn.getMutationType())==null?void 0:Yc.getFields());var Qc;const fD=Os((Qc=fn.getSubscriptionType())==null?void 0:Qc.getFields()),Ro=Nt.keyBy(Vf(),i=>i.name.toLocaleLowerCase()),dD=Nt.mapValues(Ro,i=>{const n=yo.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(s=>s.name===t)).filter(t=>!!t):[]}),pD=Os(fn.getTypeMap()),hD=sD(fn);function Os(i){return Nt.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function mD(){return Nt.size(fn.getTypeMap())<=10}function gD(){return[oo("Queries",fn.getQueryType()),oo("Mutations",fn.getMutationType()),oo("Subscriptions",fn.getSubscriptionType()),DD(),ED()].filter(i=>!!i)}function oo(i,n){return TD(i,yD(n))}function yD(i){return Nt.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function TD(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:fr.joinUrlPaths(Ds,i.toLocaleLowerCase(),t.name)}))}}function ED(){return mD()?null:{type:"menu",title:"Types",children:Nt.sortBy(Nt.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:fr.joinUrlPaths(Ds,"types",n.name)}))}}function PD(){return!!fn.getQueryType()}function UD(i){return lD[i.toLocaleLowerCase()]}function MD(){return!!fn.getMutationType()}function $D(i){return cD[i.toLocaleLowerCase()]}function VD(){return!!fn.getSubscriptionType()}function GD(i){return fD[i.toLocaleLowerCase()]}function qD(i){return pD[i.toLocaleLowerCase()]}function ID(i){return Ro[i.toLocaleLowerCase()]}function jD(i){return ID(i.name)!==void 0}function WD(){return Nt.size(Ro)>0}function YD(i){return dD[i.name.toLocaleLowerCase()]||[]}function QD(i){if(i)return hD.getFor(i)}function zD(i){return Nt.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:$f(n,i)}))}function $f(i,n){return i?i.description?[{description:i.description,from:n}]:Tn(n)?n.getInterfaces().flatMap(t=>$f(t.getFields()[i.name],t)):[]:[]}function Vf(){return yo.some(i=>(i==null?void 0:i.name)==="*")?fn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):yo.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?fn.getDirective(i):void 0).filter(i=>!!i)}function vD(){return qc.trim().length===0?eD(JSON.parse(JSON.stringify({__schema:{types:[]}}))):iD(qc)}function DD(){const i=Vf();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:fr.joinUrlPaths(Ds,"directives",n.name),section:"Directives"}))}}const JD=wo(bo.APP_TITLE,"GraphQL Documentation"),Gf=AD().concat(gD());wD(Gf);const _D=Object.freeze(Gf),HD=bD();function AD(){return wo(bo.PAGES,CD()).filter(n=>!!n).map(n=>jf([],n))}function bD(){const i=SD();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function wD(i){function n(s,a){for(const u of s){if(u.type==="page"){a(u);continue}u.type==="menu"&&n(u.children,a)}}let t;n(i,s=>{t&&(t.next={title:s.title,section:s.section,href:s.href},s.previous={title:t.title,section:t.section,href:t.href}),t=s})}function SD(){return qf(()=>!0)}function XD(i){return qf(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function qf(i){function n(t){for(const s of t){if(s.type==="page"&&i(s))return s;if(s.type==="menu"){const a=n(s.children);if(a)return a}}return null}return n(_D)}function jf(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:fr.joinUrlPaths(Ds,...i,jc(n.title))};const t=i.concat([jc(n.title)]);return{type:"menu",title:n.title,children:n.content.map(s=>({...jf(t,s),section:n.title}))}}function jc(i){return fr.generatePathSegment(i,new tf)}function CD(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{PD as A,tf as B,UD as C,VD as D,GD as E,uv as F,ln as G,di as H,vf as I,If as J,qD as K,QD as L,zD as M,jD as N,_ as O,BD as P,_s as Q,or as R,Xc as S,xD as T,tr as U,oI as V,Nt as _,kD as a,wo as b,Jn as c,Tn as d,ct as e,cn as f,Jc as g,Jt as h,Zn as i,Kn as j,et as k,mD as l,ve as m,JD as n,LD as o,_D as p,HD as q,XD as r,fn as s,bo as t,fr as u,WD as v,ID as w,YD as x,MD as y,$D as z};
