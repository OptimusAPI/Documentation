...
`,1)[0],k=0;this.options.pedantic?(k=2,p=D.trimStart()):(k=t[2].search(/[^ ]/),k=k>4?1:k,p=D.slice(k),k+=t[1].length);let x=!1;if(!D&&/^ *$/.test(S)&&(d+=S+`
...
`;class rv{constructor(n){Ie(this,"mapping");this.mapping=n}getFor(n){return this.mapping.get(n.name)}}var ar;(function(i){i.UNION="union",i.ARGUMENT="argument",i.FIELD="field"})(ar||(ar={}));function sv(i){const n=new Map;return ov(i,t=>{Tn(t)&&av(t,s=>{const o=ga(s.type);aa(n,o).references.push({kind:ar.FIELD,parent:t,by:s}),uv(s,l=>{const d=ga(l.type);aa(n,d).references.push({kind:ar.ARGUMENT,field:s,type:t,by:l})})}),Kn(t)&&t.getTypes().forEach(s=>{aa(n,s).references.push({kind:ar.UNION,by:t})})}),new rv(n)}function ov(i,n){Object.entries(i.getTypeMap()).forEach(([,t])=>{t.name.startsWith("__")||n(t)})}function av(i,n){Object.entries(i.getFields()).forEach(([,t])=>{n(t)})}function uv(i,n){Object.entries(i.args).forEach(([,t])=>{n(t)})}function aa(i,n){let t=i.get(n.name);return t||(t={references:[]},i.set(n.name,t)),t}function ga(i){return ln(i)||di(i)?ga(i.ofType):i}const fn=Dv(),ya=wa(ba.DIRECTIVES,[]);var Yc;const lv=Os((Yc=fn.getQueryType())==null?void 0:Yc.getFields());var Wc;const cv=Os((Wc=fn.getMutationType())==null?void 0:Wc.getFields());var Qc;const fv=Os((Qc=fn.getSubscriptionType())==null?void 0:Qc.getFields()),ka=Ct.keyBy(Vf(),i=>i.name.toLocaleLowerCase()),dv=Ct.mapValues(ka,i=>{const n=ya.find(t=>(t==null?void 0:t.name)===i.name||(t==null?void 0:t.name)==="*");return n?n.args.some(t=>t==="*")?i.args:n.args.map(t=>i.args.find(s=>s.name===t)).filter(t=>!!t):[]}),pv=Os(fn.getTypeMap()),hv=sv(fn);function Os(i){return Ct.mapKeys(i||{},(n,t)=>t.toLocaleLowerCase())}function mv(){return Ct.size(fn.getTypeMap())<=10}function gv(){return[ua("Queries",fn.getQueryType()),ua("Mutations",fn.getMutationType()),ua("Subscriptions",fn.getSubscriptionType()),vv(),Ev()].filter(i=>!!i)}function ua(i,n){return Tv(i,yv(n))}function yv(i){return Ct.sortBy((i==null?void 0:i.getFields())||{},n=>n.name)}function Tv(i,n){return n.length===0?null:{type:"menu",title:i,children:n.map(t=>({type:"page",title:t.name,section:i,deprecated:!!t.deprecationReason,href:fr.joinUrlPaths(vs,i.toLocaleLowerCase(),t.name)}))}}function Ev(){return mv()?null:{type:"menu",title:"Types",children:Ct.sortBy(Ct.map(fn.getTypeMap()),n=>n.name).filter(n=>!n.name.startsWith("__")).map(n=>({type:"page",title:n.name,section:"Types",href:fr.joinUrlPaths(vs,"types",n.name)}))}}function Pv(){return!!fn.getQueryType()}function Uv(i){return lv[i.toLocaleLowerCase()]}function Mv(){return!!fn.getMutationType()}function $v(i){return cv[i.toLocaleLowerCase()]}function Vv(){return!!fn.getSubscriptionType()}function Gv(i){return fv[i.toLocaleLowerCase()]}function qv(i){return pv[i.toLocaleLowerCase()]}function Iv(i){return ka[i.toLocaleLowerCase()]}function jv(i){return Iv(i.name)!==void 0}function Yv(){return Ct.size(ka)>0}function Wv(i){return dv[i.name.toLocaleLowerCase()]||[]}function Qv(i){if(i)return hv.getFor(i)}function zv(i){return Ct.flatMap(i.getFields(),n=>({field:n,possibleDescriptions:$f(n,i)}))}function $f(i,n){return i?i.description?[{description:i.description,from:n}]:Tn(n)?n.getInterfaces().flatMap(t=>$f(t.getFields()[i.name],t)):[]:[]}function Vf(){return ya.some(i=>(i==null?void 0:i.name)==="*")?fn.getDirectives().filter(i=>!["include","skip","deprecated","specifiedBy"].includes(i.name)):ya.filter(i=>!!(i!=null&&i.name)).map(({name:i})=>i?fn.getDirective(i):void 0).filter(i=>!!i)}function Dv(){return qc.trim().length===0?ev(JSON.parse(JSON.stringify({__schema:{types:[]}}))):iv(qc)}function vv(){const i=Vf();return i.length===0?null:{type:"menu",title:"Directives",children:i.map(n=>({type:"page",title:n.name,href:fr.joinUrlPaths(vs,"directives",n.name),section:"Directives"}))}}const Jv=wa(ba.APP_TITLE,"GraphQL Documentation"),Gf=Av().concat(gv());wv(Gf);const _v=Object.freeze(Gf),Xv=bv();function Av(){return wa(ba.PAGES,Fv()).filter(n=>!!n).map(n=>jf([],n))}function bv(){const i=Sv();if(i)return i.href;throw new Error("No custom pages or query available to use as the root application URL. You need to provide at least one custom page or your schema should contain at least one query/mutation/subscription.")}function wv(i){function n(s,o){for(const u of s){if(u.type==="page"){o(u);continue}u.type==="menu"&&n(u.children,o)}}let t;n(i,s=>{t&&(t.next={title:s.title,section:s.section,href:s.href},s.previous={title:t.title,section:t.section,href:t.href}),t=s})}function Sv(){return qf(()=>!0)}function Hv(i){return qf(n=>n.href.toLocaleLowerCase()===i.toLocaleLowerCase())}function qf(i){function n(t){for(const s of t){if(s.type==="page"&&i(s))return s;if(s.type==="menu"){const o=n(s.children);if(o)return o}}return null}return n(_v)}function jf(i,n){if(typeof n.content=="string")return{type:"page",title:n.title,content:n.content,href:fr.joinUrlPaths(vs,...i,jc(n.title))};const t=i.concat([jc(n.title)]);return{type:"menu",title:n.title,children:n.content.map(s=>({...jf(t,s),section:n.title}))}}function jc(i){return fr.generatePathSegment(i,new tf)}function Fv(){return[{title:"Introduction",content:[{title:"Welcome",content:`
        ...
        `.split(`
`).map(i=>i.trim()).join(`
`)}]}]}export{Pv as A,tf as B,Uv as C,Vv as D,Gv as E,uD as F,ln as G,di as H,Df as I,If as J,qv as K,Qv as L,zv as M,jv as N,_ as O,Bv as P,_s as Q,ar as R,Hc as S,xv as T,tr as U,aI as V,Ct as _,Rv as a,wa as b,Jn as c,Tn as d,ct as e,cn as f,Jc as g,Jt as h,Zn as i,Kn as j,et as k,mv as l,De as m,Jv as n,Lv as o,_v as p,Xv as q,Hv as r,fn as s,ba as t,fr as u,Yv as v,Iv as w,Wv as x,Mv as y,$v as z};
