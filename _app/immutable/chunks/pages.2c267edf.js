...
type Query {
  ...
  <img src="https://usdvexperts.com/wp-content/uploads/2016/02/c286ca98c6c79cf50000cab7a5344393-e1458196160872.png" alt="pending" width="32" style="vertical-align:middle"/>
  <p>
  This method returns pending Points and Rewards which will be applied after order is fulfilled
  </p>
  </div>
  """
  CustomerPendingPointsRewards(input: CustomerPendingPointsRewardsInput!): CustomerPendingPointsRewardsResponse
  """
  <div>
  <img src="https://cdn3d.iconscout.com/3d/premium/thumb/cross-sign-8749566-7139691.png?f=webp" alt="not verified" width="32" style="vertical-align:middle"/>
  <img src="https://usdvexperts.com/wp-content/uploads/2016/02/c286ca98c6c79cf50000cab7a5344393-e1458196160872.png" alt="pending" width="32" style="vertical-align:middle"/>
  ...
  """
  CustomerHistoryPointsOrRewards(input: CustomerHistoryPointsOrRewardsInput!): CustomerHistoryPointsOrRewardsResponse
}
...
input CancelFulfilOrderInput {
  """Original Fullfill Transaction Id """
  transactionId: String!
}
...
input CustomerHistoryPointsOrRewardsInput {
  "Filter by dates range"
  dates: DatesEntity
  "Filter by Points or Rewars"
  type: PointsType
...
type CreditResponse {
  "Details of the applied credit"
  details: TransactionEntity!
}
...
type CustomerHistoryPointsOrRewardsResponse {
  historyItems: [HistoryPointsOrRewardsItem]
}
...
type HistoryPointsOrRewardsItem {
  created: String!
  transactionId: String!
  parentTransactionId: String
  value: Int!
